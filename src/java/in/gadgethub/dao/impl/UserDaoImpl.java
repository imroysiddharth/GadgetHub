...
public class UserDaoImpl implements UserDao{
    public boolean isRegistered(String emailid) {
        ...
        boolean flag = false;
        try {
            ps = conn.prepareStatement("slect * from user where useremail= ?");
            ...
            System.out.println("Error in isRegistred" + ex);
            ex.printStackTrace();
        }
    ...
    public String registerUser(UserPojo user) {
        String status = "Registraion Failed";
    ...
    public String getUserAdd(String emailId){
        String address =null ;
         PreparedStatement ps = null ;
        ResultSet rs = null ;
        Connection conn = DBUtil.provideConnection();
